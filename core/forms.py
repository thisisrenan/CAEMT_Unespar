...
class EstagiarioForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = '__all__'
        exclude = ['role', 'user_permissions', 'groups', 'is_staff', 'is_superuser', 'last_login', 'is_active']
        fields = ['username', 'password', 'password_confirm', 'first_name', 'last_name', 'email', 'data_de_nascimento','ano_letivo', 'telefone','orientador_responsavel', 'image']
...
class EstagiarioFormEdit(forms.ModelForm):
    class Meta:
        model = Estagiario
        exclude = ['role', 'user_permissions', 'groups', 'is_staff', 'is_superuser', 'last_login', 'is_active']
        fields = ['username', 'first_name', 'last_name', 'data_de_nascimento', 'telefone','orientador_responsavel','ano_letivo','image']
